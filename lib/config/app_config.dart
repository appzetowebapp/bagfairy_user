...
class AppConfig {
  // ==================== APP IDENTITY ====================
  static const String appName = 'Bagferi';
  ...
  static const String webUrl = 'https://bagferi.com/b2b/landing';
  ...
  static const String apiBaseUrl = 'https://api.Bagferi.com/api/v1';
  static const String fcmTokenUrl =
      'https://bagferi.com/api/fcm-tokens/save';
